...
return [
    ...
    // Emails
    'email' => [
        'welcome_subject' => 'Welcome to Dataflow!',
        'password_reset_subject' => 'Reset your password - Dataflow',
        'document_limit_subject' => '⚠️ Approaching document limit - Dataflow',
    ],
