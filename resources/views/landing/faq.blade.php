...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-4 sm:px-6 max-w-4xl">
        ...
        <div class="mb-12 bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-4 sm:p-6 md:p-8 text-white shadow-2xl">
            <h2 class="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 flex items-center">
        ...
        <div class="space-y-6">
            ...
            {{-- GUÍA COMPLETA --}}
            <div id="guia-completa" class="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 border-l-4 border-purple-600">
                ...
                <div class="prose prose-lg max-w-none">
                    ...
                    {{-- PASO 1 --}}
                    <div class="mb-10 bg-purple-50 rounded-lg p-4 sm:p-5 md:p-6 border-l-4 border-purple-500">
                        <h3 class="text-xl sm:text-xl sm:text-2xl font-bold text-purple-700 mb-4 flex items-center">
                            <span class="bg-purple-600 text-white w-8 h-8 sm:w-10 sm:h-10 rounded-full text-base sm:text-xl flex items-center justify-center mr-2 sm:mr-3 text-lg sm:text-xl">1</span>
                            Configuración Inicial (5 minutos)
                        </h3>

                        <div class="space-y-4 text-gray-700">
                            <div class="bg-white rounded p-3 sm:p-4 shadow-sm">
                            ...
                            <div class="bg-white rounded p-3 sm:p-4 shadow-sm">
                                ...
                                <ol class="list-decimal list-inside space-y-2 ml-4">
                                    ...
                                    <li>Busca <code class="bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs sm:text-sm">@dataflow_guaraniappstore_bot</code> en Telegram</li>
                                    <li>Envía <code class="bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs sm:text-sm">/start</code> al bot</li>
                                    <li>El bot te dará un código de 9 dígitos (ej: <code class="bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs sm:text-sm">123456789</code>)</li>
                    ...
                    {{-- PASO 2 --}}
                    <div class="mb-10 bg-blue-50 rounded-lg p-4 sm:p-5 md:p-6 border-l-4 border-blue-500">
                        <h3 class="text-xl sm:text-xl sm:text-2xl font-bold text-blue-700 mb-4 flex items-center">
                            <span class="bg-blue-600 text-white w-8 h-8 sm:w-10 sm:h-10 rounded-full text-base sm:text-xl flex items-center justify-center mr-2 sm:mr-3 text-lg sm:text-xl">2</span>
                            Procesar Facturas
                        </h3>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-white rounded p-3 sm:p-4 shadow-sm">
                                ...
                                <ol class="list-decimal list-inside space-y-2 ml-4 text-gray-700">
                                    <li>Abre el bot de Telegram <code class="bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs sm:text-sm">@dataflow_guaraniappstore_bot</code></li>
                            ...
                            <div class="bg-white rounded p-3 sm:p-4 shadow-sm opacity-75">
                                <h4 class="font-bold text-gray-600 mb-2">📧 Opción C: Por Email (Próximamente)</h4>
                                <p class="text-gray-600 text-sm">Envía facturas a <code class="bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs sm:text-sm">facturas@dataflow.com</code> y se procesarán automáticamente.</p>
                            </div>
                        </div>
                    </div>

                    {{-- PASO 3 --}}
                    <div class="mb-10 bg-yellow-50 rounded-lg p-4 sm:p-5 md:p-6 border-l-4 border-yellow-500">
                        <h3 class="text-xl sm:text-xl sm:text-2xl font-bold text-yellow-700 mb-4 flex items-center">
                            <span class="bg-yellow-600 text-white w-8 h-8 sm:w-10 sm:h-10 rounded-full text-base sm:text-xl flex items-center justify-center mr-2 sm:mr-3 text-lg sm:text-xl">3</span>
                    ...
                    {{-- PASO 4 --}}
                    <div class="mb-10 bg-green-50 rounded-lg p-4 sm:p-5 md:p-6 border-l-4 border-green-500">
                        <h3 class="text-xl sm:text-xl sm:text-2xl font-bold text-green-700 mb-4 flex items-center">
                            <span class="bg-green-600 text-white w-8 h-8 sm:w-10 sm:h-10 rounded-full text-base sm:text-xl flex items-center justify-center mr-2 sm:mr-3 text-lg sm:text-xl">4</span>
                        ...
                        <div class="space-y-4 text-gray-700">
                            ...
                            <div class="bg-white rounded p-3 sm:p-4 shadow-sm">
                                ...
                                <ol class="list-decimal list-inside space-y-2 ml-4">
                                    ...
                                    <li>Se descarga un archivo <code class="bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs sm:text-sm">.xlsx</code> con esta estructura:</li>
                                </ol>
                    ...
                    {{-- PASO 5 --}}
                    <div class="mb-10 bg-indigo-50 rounded-lg p-4 sm:p-5 md:p-6 border-l-4 border-indigo-500">
                        <h3 class="text-xl sm:text-xl sm:text-2xl font-bold text-indigo-700 mb-4 flex items-center">
                            <span class="bg-indigo-600 text-white w-8 h-8 sm:w-10 sm:h-10 rounded-full text-base sm:text-xl flex items-center justify-center mr-2 sm:mr-3 text-lg sm:text-xl">5</span>
                            Casos Especiales
                        </h3>
                    ...
                    {{-- CONSEJOS FINALES --}}
                    <div class="bg-gray-800 text-white rounded-lg p-4 sm:p-5 md:p-6">
